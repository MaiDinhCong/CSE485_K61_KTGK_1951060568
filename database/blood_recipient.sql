...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 21, 2021 lúc 05:15 AM
...
CREATE TABLE `blood_recipient` (
  ...
  `reci_bgrp` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `reci_bqnty` int(11) NOT NULL,
  `reci_sex` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `reci_reg_date` datetime NOT NULL DEFAULT current_timestamp(),
  `reci_phno` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL
...
(1, 'Mai Đình Công', 21, 'A', 200, 'Nam', '2021-10-21 10:14:04', '033333333'),
(2, 'Mai Công Đình', 22, 'B', 100, 'Nữ', '2021-10-21 10:14:36', '011111111');
